                        ...
                        <tbody>
                            ...
                            <tr>
  					 				<td>
										...
										<span class="id"  hidden="true" >${trainer.id}</span>
  					 				</td>
  					 				<td>${trainer.trainerName}</td>
  					 				<td>${trainer.classType}</td>
  					 				<td>${trainer.trainerEntry_time}</td>
  					 				<td>${trainer.trainerWork_experience}</td>
  					 				<td>${trainer.trainerStatus}</td>
  					 				<th>
  					 					<div class="btn-group">                                        
                                        	<button data-toggle="dropdown" class="btn dropdown-toggle">请选择 <span class="caret"></span>
                                        	</button>
