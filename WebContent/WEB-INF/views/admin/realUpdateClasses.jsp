...
<body>
    ...
    <div class="content">
        ...
        <div class="workplace">
        <div class="span6">                                        
                <form:form action="updateclasses" method="POST" modelAttribute="classes" >
                    <div class="block-fluid without-head">                        
                        ...
                        <div class="row-form clearfix">
                            <div class="span3">班级类型</div>
                            <div class="span9"> 
                             <form:input   path="classType"/>
       						</div>
                        </div>

                        <div class="row-form clearfix ">
                            <div class="span3">班主任</div>
                            <div class="span9">
                            <form:input  path="adviserName"/>
                            </div>
                        </div>                                                
                        
                        <div class="row-form clearfix">
                            <div class="span3">讲师</div>
                            <div class="span9"><form:input path="trainerName"/></div>
                        </div>
                        <div class="row-form clearfix">
                            <div class="span3">开班时间</div>
                            <div class="span9"><form:input path="classBeginDate"/></div>
                        </div>                        
                        <div class="row-form clearfix">
                            <div class="span3">学习时长</div>
                            <div class="span9"><form:input path="classDuration" cssClass="input-mini"/></div>
                        </div>                        
                        <div class="row-form clearfix">
                            <div class="span3">状态</div>
                            <div class="span9"><form:input path="classStatus" /></div>
                        </div>                        
                    </div>                    
             <form:button value="提交"></form:button>
                    </form:form>
                </div>
