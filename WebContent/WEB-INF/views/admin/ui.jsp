            ...
            <div class="span12">                    
                <div class="head clearfix">
                  <input type="submit"  id="batchDel" class="btn btn-default" value="批量删除">
                    <form action="findadviser" style="float:right " >
						<input type="text" placeholder="请输入姓名" name="adviserName">
                ...
                <div class="block-fluid">
                    <table cellpadding="0" cellspacing="0" width="100%" class="table">
                       ...
                       <tbody>
                        <c:forEach var="allClassesList" items="${allClassesList}">
                            <tr>
                                <td>
                                    <input  name="box" type="checkbox"/>
                                    <span class="id"  hidden="true" >${allClassesList.id}</span>
                                </td>
                                <td width="12%">${allClassesList.adviserName}</td>
                                <td width="12%">${allClassesList.adviserEntry_time}</td>
                                <td width="12%">${allClassesList.adviserWork_experience}</td>
                                <td width="12%">${allClassesList.adviserStatus}</td> 
								<th>
								 <div class="btn-group">                                        
                                        <button data-toggle="dropdown" class="btn dropdown-toggle">请选择 <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a  href="realUpdateClasses?className=${allClasses.className }&classType=${allClasses.classType }&adviserName=${allClasses.adviserName}&
                                            trainerName${allClasses.trainerName }&classBeginDate=${allClasses.classBeginDate }&
                                            classDuration=${allClasses.classDuration }&classStatus=${allClasses.classStatus }">修改</a></li>
