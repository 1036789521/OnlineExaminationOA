...
<body>
					...
					<form:form style="text-align: center;"
						...
						<table>
							<tbody>
								...
								<tr>
									<td>选项A:</td>
									<td><form:input path="option_A" /></td>
								</tr>
								<tr>
									<td>选项B:</td>
									<td><form:input path="option_B" /></td>
								</tr>
								<tr>
									<td>选项C:</td>
									<td><form:input path="option_C" /></td>
								</tr>
								<tr>
									<td>选项D:</td>
									<td><form:input path="option_D" /></td>
								</tr>
								<tr>
									<td>题目的答案:</td>
	...
	function fun1(data)
	{
		...
		if("2"==data){
			window.location.href='${pageContext.request.contextPath}/studentpaper/additem2';
		}
		if("3"==data){
